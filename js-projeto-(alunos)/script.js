...
const text = "Lorena"; // Nome da aluna
let index = 0;
let isTyping = true;
...
function animateText() {
  if (isTyping) {
    ...
    if (index > 1) {
      ...
      currentColor = currentColor === (document.documentElement.classList.contains('light') ? 'black' : '#fff') ? '#d400ff ' : (document.documentElement.classList.contains('light') ? 'black' : '#fff');
